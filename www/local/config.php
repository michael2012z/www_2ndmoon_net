...
$WikiTitle = '第二月 The Second Moon';

$WikiTag = '六尘缘影为自心相。譬彼病目，见空中花及第二月。 ——《圆觉经》';
...
# $PageLogoUrl = "$PubDirUrl/skins/glossyhue/color-blue/images/logo.jpg";
$PageLogoUrl = "";
...
$EnableUpload = 1;
$DefaultPasswords['upload'] = crypt('www2ndmoonnet');
$DefaultPasswords['admin'] = crypt('www2ndmoonnet');
$DefaultPasswords['edit'] = array(crypt('www2ndmoonnet'));
